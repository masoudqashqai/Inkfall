...
defineActor('trenchMan', function (e) {                       // detective: trench coat + fedora
  ...
  c.beginPath(); c.moveTo(20 * s, -89 * s); c.lineTo(ex, ey); c.lineTo(hx, hy); c.stroke();   // cigarette arm: tucked up under the shoulder, nearly straight, up to the mouth as it raises
  c.beginPath(); c.moveTo(-20 * s, -89 * s); c.lineTo(-24 * s, -38 * s); c.stroke();           // other arm tucked under the shoulder, hangs nearly straight at his side
  c.strokeStyle = 'rgba(150,160,178,0.3)'; c.lineWidth = 1.4 * s; c.beginPath(); c.moveTo(20 * s, -90 * s); c.lineTo(ex, ey); c.stroke();
